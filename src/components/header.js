  ...
  header.innerHTML = `
    <div class="header">
      ...
      <div class="header-right">
        ...
        <a href="https://github.com/caiomtls/data_color_toolkit" target="_blank" rel="noopener" class="theme-toggle" data-tooltip="GitHub" style="display: flex; align-items: center; justify-content: center; color: inherit; text-decoration: none;">
